...
public class SettingsActivity extends PreferenceActivity implements ButtonBarHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("com.oct.tentacles.START_NEW_FRAGMENT".equals(getIntent().getAction())) {
            String className = getIntent().getStringExtra("tentacles_fragment_name").toString();
            Class<?> cls = null;
            try {
    ...
    public void onHeaderClick(Header header, int position) {
        ...
        if (header.id == R.id.more_device_settings) {
            try {
                ...
                intent.setClassName("com.tentacles.device", "com.tentacles.device.DeviceSettings");
